  ...
  return (
      <div>
          <h1 className='text-lato text-4xl mt-40 ml-16 bg-gradient-to-br from-teal-500 to-emerald-100 bg-clip-text text-transparent'>Experience</h1>
              <div className="flex flex-col w-1/2 h-fit items-center mx-auto gap-24">
                <div className='flex w-fit justify-end items-center gap-9'>
                  <Image className="h-28 w-28 rounded-full object-cover shadow-md border-4 border-white" src={civiconnect} alt=""/>
                  <div className ="w-5/12 bg-white p-2 rounded-md shadow-md text-[#EEF0F2] bg-gradient-to-r from-indigo-400 to-indigo-700">
                    <h2>Web Developer</h2>
                      <h3>Civiconnect</h3>
                ...
                <div className='flex w-fit items-center gap-9'>
                  <div className ="w-5/12 p-2 rounded-md shadow-md text-[#EEF0F2] bg-gradient-to-r from-slate-500 to-slate-800 ">
                  ...
                  <Image className="h-28 w-28 rounded-full object-cover shadow-md border-4 border-white" src={ontario} alt=""/>
                </div>



                <div className='flex w-fit justify-end items-center gap-9'>
                  <Image className="h-28 w-28 rounded-full object-cover shadow-md border-4 border-white" src={markel} alt=""/>
                  <div className ="w-5/12 p-2 rounded-md shadow-md text-[#EEF0F2] bg-gradient-to-r from-slate-500 to-slate-800 ">
